  ...
  return (
    <div className="flex flex-col items-center text-center text-amber-900 p-8 rounded-2xl bg-white/60 backdrop-blur-md shadow-2xl border border-white/30">
      ...
      <div className="flex flex-col gap-4 mb-8">
        <button
          onClick={() => onSelectDifficulty(Difficulty.Beginner)}
        ...
        <button
          onClick={() => onSelectDifficulty(Difficulty.Intermediate)}
        ...
        >
         ...
         <button
          onClick={() => onSelectDifficulty(Difficulty.Advanced)}
      ...
      <div className="flex flex-row flex-wrap justify-center gap-4">
          <button onClick={onGoToCandySelection} className="px-6 py-2 bg-gradient-to-b from-purple-500 to-purple-600 text-white text-xl font-bold rounded-full shadow-md transform hover:scale-105 transition-transform duration-300">飴を選ぶ</button>
          <button onClick={onGoToRanking} className="px-6 py-2 bg-gradient-to-b from-blue-500 to-blue-600 text-white text-xl font-bold rounded-full shadow-md transform hover:scale-105 transition-transform duration-300">ランキング</button>
          <button onClick={onGoToMiniGame} className="px-6 py-2 bg-gradient-to-b from-pink-500 to-pink-600 text-white text-xl font-bold rounded-full shadow-md transform hover:scale-105 transition-transform duration-300">ミニゲーム</button>
      </div>
    </div>
  );
};
